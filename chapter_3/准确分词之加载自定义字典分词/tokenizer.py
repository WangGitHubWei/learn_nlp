...
from jpype import *
root_path="E:/windows/BaiduNetdiskDownload/NLP/hanlp/hanlp-1.7.3-release"
djclass_path="-Djava.class.path="+root_path+"/"+"hanlp-1.7.3.jar;"+root_path
